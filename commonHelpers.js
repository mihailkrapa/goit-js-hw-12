import{a as v,S as _,i as d}from"./assets/vendor-64b55ca9.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function r(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(s){if(s.ep)return;s.ep=!0;const o=r(s);fetch(s.href,o)}})();const m={API_KEY:"26114723-eab203642ec2629c12fb3e14b",BASE_URL:"https://pixabay.com/api"};async function h(e,t){const r={key:m.API_KEY,page:t,per_page:15,q:e,image_type:"image",orientation:"horizontal",safesearch:!0};return(await v.get(`${m.BASE_URL}/`,{params:r})).data}const x=new _(".images-list a",{captionsData:"alt",captionDelay:250});function y(e,t){e.insertAdjacentHTML("beforeend",C(t)),x.refresh()}function C(e){return e.map(P).join("")}function P({webformatURL:e,largeImageURL:t,tags:r,likes:a,views:s,comments:o,downloads:i}){return`
      ...
      `}const q="/goit-js-hw-12/assets/error-d765a61d.svg",$="/goit-js-hw-12/assets/warning-33a8e06d.svg",E="/goit-js-hw-12/assets/success-9451f8db.svg",I=document.querySelector(".js-hero-form"),g=document.querySelector(".images-list"),b=document.querySelector(".loader"),u=document.querySelector(".js-load-more-btn");let n=1,c,p;const w=15,j=async()=>{S(),n+=1;const e=await h(c,n);y(g,e.hits);const t=Math.ceil(e.totalHits/w);n===t&&(l(),L("We're sorry, but you've reached the end of search results.")),f(),O()},B=async e=>{e.preventDefault(),g.innerHTML="",n=1,c=e.target.elements.query.value.trim(),c===""&&(l(),H()),S();try{const t=await h(c,n);t.hits.length===0&&(f(),l(),L("Sorry, there are no images matching<br> your search query. Please try again!"),e.target.reset()),t.totalHits<w?l():M(),A(t),y(g,t.hits)}catch(t){console.error(t)}f(),e.target.reset()};u.addEventListener("click",j);I.addEventListener("submit",B);function H(){d.warning({titleColor:"#fff",messageColor:"#fff",backgroundColor:"#ffa000",iconUrl:$,message:"Please enter a search query",position:"topRight"})}function L(e){d.error({titleColor:"#fff",messageColor:"#fff",backgroundColor:"#ef4040",iconUrl:q,message:e,position:"topRight"})}function A(e){d.success({titleColor:"#fff",messageColor:"#fff",backgroundColor:"#28a745",message:`We found ${e.totalHits} images.`,iconUrl:E,position:"topRight"})}function S(){b.classList.add("visible")}function f(){b.classList.remove("visible")}function M(){u.classList.remove("is-hidden")}function l(){u.classList.add("is-hidden")}function O(){p=document.querySelector(".images__image").getBoundingClientRect().height,window.scrollBy({top:2*p,behavior:"smooth"})}
